...
*This is part 1 of a 4-part series. All figures are generated by
...
presented a memoir to the Institut de France, *Mémoire sur la propagation de la chaleur
dans les corps solides*, on how heat spreads through a solid body. Buried in it was a
...
[*Théorie analytique de la chaleur*](https://en.wikipedia.org/wiki/Th%C3%A9orie_analytique_de_la_chaleur).
Making his claim precise took much of the nineteenth century and, along the way, forced
mathematics to sharpen its ideas of *function*, *limit*, and *integral* —
...
[*epicycles*](https://en.wikipedia.org/wiki/Deferent_and_epicycle). That is Fourier
...
*negative* real direction — the triangle looks the same, while $\cos\theta$ has
...
converges at every point, yet not *uniformly* near the discontinuity:
...
- **Astronomy.** Ptolemy's
  [epicycles](https://en.wikipedia.org/wiki/Deferent_and_epicycle) *are* a finite
...
- **Chemistry and medicine.** An
  ...
  hits nuclei with a pulse and records the decaying echo; the spectrum *is* its
...
- Kahane, [*Le retour de Fourier*](https://www.academie-sciences.fr/pdf/dossiers/Fourier/Fourier_pdf/Fourier_Kahane.pdf)
